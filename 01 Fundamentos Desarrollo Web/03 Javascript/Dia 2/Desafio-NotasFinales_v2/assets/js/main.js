...
var carrera = prompt("Ingresa una carrera: ", "Desarrollo Web");

//Ingreso del primer ramo
var ramo1 = prompt("Ingresa primer ramo: ", "HTML");

//Ingreso de notas primer ramo
var nota1 = prompt("Ingrese nota 1 [" + ramo1 + "]", "4");
var nota2 = prompt("Ingrese nota 2 [" + ramo1 + "]", "5");
var nota3 = prompt("Ingrese nota 3 [" + ramo1 + "]", "4");

//Ingreso del segundo ramo
var ramo2 = prompt("Ingresa segundo ramo: ", "CSS");

//Ingreso de notas segundo ramo
var nota4 = prompt("Ingrese nota 1 [" + ramo2 + "]", "3");
var nota5 = prompt("Ingrese nota 2 [" + ramo2 + "]", "4");
var nota6 = prompt("Ingrese nota 3 [" + ramo2 + "]", "5");

//Ingreso del tercer ramo
var ramo3 = prompt("Ingresa un tercer ramo: ", "JavaScript");

//Ingreso de notas tercer ramo
var nota7 = prompt("Ingrese nota 1 [" + ramo3 + "]", "2");
var nota8 = prompt("Ingrese nota 2 [" + ramo3 + "]", "6");
var nota9 = "-";
var notaAprobacion = prompt("Ingrese nota aprobación [" + ramo3 + "]", "4");

//Se agrega logo desafio latam
document.write("<img class='logoCustom' src='./assets/img/logo_dlatam.png'>")
...
//Encabezado
document.write("<table class='table table-borderless w-50'>");
