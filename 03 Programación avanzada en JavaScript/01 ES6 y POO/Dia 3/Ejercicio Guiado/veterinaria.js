//Entidad Veterinaria (clinica) que tiene nombre y mascota
//Entidad Mascota que tiene nombre, edad, chip, diagnostico
//Entidad Veterinaria, puede tener una o mas Mascotas (entidad)
...
Veterinaria.prototype.getMascota = function(){
    this._mascota().forEach(function(elemento, indice){
        console.log('----------------------------------------');
...
Mascota.prototype.setChip = function(chip){
    this._chip = function(){
        return chip;
    }
}

Mascota.prototype.setDiagnostico = function(diagnostico){
    this._diagnostico = function(){
        return diagnostico;
    }
}
...
var mascotaUno = new Mascota('mascota 1', '2 meses', 'si', 'micho enfermito');
